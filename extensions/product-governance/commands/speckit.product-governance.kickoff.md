...
2. Copy
   `.specify/extensions/product-governance/templates/agile-implementation-plan-template.md`
   to `.specify/product-governance/agile-plan-input.md`.
...
{SCRIPT} --json agile kickoff \
  --input ".specify/product-governance/agile-plan-input.md" \
  --approve
```
