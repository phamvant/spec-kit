# Product Governance MVP — Task Breakdown
...
- [x] PG001 [M0] Chốt extension identity `product-governance` và public command
  namespace `speckit.product-governance.*`.
...
- [ ] PG015 [P] [M0] Tạo Python package skeleton
  `scripts/product_governance/` với `__init__.py`, `cli.py`, `models.py`,
...
- [ ] PG022 [P] [M0] Tạo valid/invalid fixtures cho từng schema dưới
  `tests/extensions/product_governance/fixtures/schemas/`.
- [ ] PG023 [M0] Viết schema contract tests trong
  `tests/extensions/product_governance/test_schemas.py`, bao phủ unsupported
...
- [ ] PG040 [P] [M2] Tạo golden product fixture dưới
  `tests/extensions/product_governance/fixtures/golden_product/` với 2
