...
không buộc mọi người dùng Spec Kit phải sử dụng Agile governance.

## 2. MVP Outcome

Sau MVP, một project đã bật extension phải có thể:

1. Khởi tạo Agile governance artifacts.
...
├── agile-config.yml
├── commands/
│   ├── speckit.agile.init.md
│   ├── speckit.agile.requirement.md
│   ├── speckit.agile.impact.md
│   ├── speckit.agile.validate.md
│   ├── speckit.agile.verify.md
│   ├── speckit.agile.changelog.md
│   └── speckit.agile.audit.md
├── scripts/
│   ├── agile/
│   │   ├── __init__.py
│   │   ├── cli.py
...
- [x] Extension cài và gỡ sạch trên các integration format được hỗ trợ.
  Evidence: `tests/extensions/agile/test_agile.py`
...
- [x] Requirement registry và relationships được schema-validate.
  Evidence: `extensions/agile/schemas/` và schema contract tests.
...
- [x] Quickstart và migration guide được viết.
  Evidence: `extensions/agile/README.md`.
...
5. **M4 — Extension commands:** installable agile package.
...
| 2026-06-19 | Extension ID là `agile`; commands dùng `speckit.agile.*` | Approved |
